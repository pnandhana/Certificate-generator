...
FONT_FILE = ImageFont.truetype(
  r'/home/runner/hackthon/front/public/data/uploads/font/GreatVibes-Regular.ttf',
  180)
FONT_COLOR = "#FFFFFF"

template = Image.open(
  r'/home/runner/hackthon/front/public/data/uploads/template.png')
...
def make_certificates(name):
  ...
  image_source.save("/home/runner/hackthon/front/public/data/uploads/out/" +
                    name + ".png")
